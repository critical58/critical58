...
public:
    ...
    std::vector<std::string> frontend         = {"Next.js", "React"};
    std::vector<std::string> backend          = {"Node.js", "Express", "Flask"};
    ...
    std::vector<std::string> toolchains       = {"npm", "yarn"};
    ...
    std::vector<std::string> editors          = {"Visual Studio Code", "Neovim};
};
```
